    ...
    <form id="formMain" runat="server">
        ...
        <asp:GridView ID="GridViewCountries" runat="server"
            ...
            <Columns>
               ...
               <%-- <asp:ImageField DataImageUrlField="ID" DataImageUrlFormatString="ShowImage.aspx?image={0}" ControlStyle-Width="40" ControlStyle-Height="40" HeaderText="Image">
                    <ItemStyle HorizontalAlign="Center" />
                </asp:ImageField>--%>
                <%--<asp:TemplateField HeaderText="Image">
                    <ItemTemplate>
                        <asp:Image ID="Image" ImageUrl='<%# "data:image/png;base64," + Convert.ToBase64String(Item.Image) %>' runat="server" Width="75" Height="75" />
                    </ItemTemplate>
                </asp:TemplateField>--%>
               <%-- <asp:TemplateField HeaderText="Country Flag">
                    <ItemTemplate>
                        <img src="<%#:Item.Image !=null?"data:image/png;base64,"+Convert.ToBase64String(Item.Image):""%> "
                            alt="<%#:Item.Image !=null?(Item.Name):"No Image" %>" />
                    </ItemTemplate>
                    <EditItemTemplate>
                        <asp:FileUpload ID="FileUploadEditFlag" filebytes='<%#: Bind("Image") %>' runat="server" />
                    </EditItemTemplate>
                </asp:TemplateField>--%>
                <asp:TemplateField>
                    <EditItemTemplate>
