<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Calculator.aspx.cs" Inherits="_05.WebCalculator.Calculator" %>
            ...
            <div class="col-md-4 well">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <asp:TextBox ID="TextBoxNumber" runat="server" CssClass="col-md-12 text-right" Height="45px" Width="375px"></asp:TextBox>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <asp:Button ID="Button7" runat="server" Text="7" OnClick="Button7_Click" CssClass="btn btn-default" Height="50px" Width="95px"/>
                    </div>
                    <div class="col-md-3">
