<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistrationForm.aspx.cs" Inherits="_03.RegistrationForm.RegistrationForm" %>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <asp:DropDownList ID="DropDownListUniversities" runat="server" Width="300px" CssClass="form-control">
                        ...
                        <asp:ListItem Value="American University in Bulgaria">American University in Bulgaria</asp:ListItem>
                        <asp:ListItem Value="Medical University - Plovdiv">Medical University - Plovdiv</asp:ListItem>
                        <asp:ListItem Value="Agricultural University – Plovdiv">Agricultural University – Plovdiv</asp:ListItem>
